...
A24model = np.poly1d(np.polyfit(dis_for_regA24, uwb_rssi_part[3], 100))
A24line = np.linspace(5, 30, 100)
...
A19model = np.poly1d(np.polyfit(dis_for_regA19, uwb_rssi_part[4], 100))
A19line = np.linspace(0, 11.5, 150)
...
A11model = np.poly1d(np.polyfit(dis_for_regA11, uwb_rssi_part[2], 150))
A11line = np.linspace(0, 5, 100)
