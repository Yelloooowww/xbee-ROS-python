...
slopeA24, intercept, r_value, p_value, std_err = stats.linregress(dis_for_regA24,xbee_rssi_part[0])
xA24 = np.arange(10,30, 0.01)
lineA24 = slopeA24*xA24+intercept
plt.plot(xA24, lineA24, 'r')
plt.text(0,50,'y = {:.2f}x + {:.2f}'.format(slopeA24,intercept),  color='r')
...
slopeA19, intercept, r_value, p_value, std_err = stats.linregress(dis_for_regA19,xbee_rssi_part[1])
xA19 = np.arange(5,20, 0.01)
lineA19 = slopeA19*xA19+intercept
plt.plot(xA19, lineA19, 'g')
plt.text(0,45,'y = {:.2f}x + {:.2f}'.format(slopeA19,intercept),  color='g')
...
slopeA11, intercept, r_value, p_value, std_err = stats.linregress(dis_for_regA11,xbee_rssi_part[7])
xA11 = np.arange(5,30, 0.01)
lineA11 = slopeA11*xA11+intercept
plt.plot(xA11, lineA11, 'b')
plt.text(0,40,'y = {:.2f}x + {:.2f}'.format(slopeA19,intercept),  color='b')
