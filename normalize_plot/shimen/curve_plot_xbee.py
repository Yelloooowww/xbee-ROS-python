...
slopeA04 *= 1.15
xA04 = np.arange(20,100, 0.01)
lineA04 = slopeA04*xA04+intercept
plt.plot(xA04, lineA04, 'g')
plt.text(24, 25,'y = {:.2f}x + {:.2f}'.format(slopeA04,intercept),  color='g')
